      ...
      {images.map((src, index) => (
        ...
        >
          <Image
            ...
            alt={index === 0 ? "Service de débouchage de canalisations" : "Service de débouchage de toilettes"}
            fill
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            {/* Carte 1: Débouchage - avec images alternantes */}
            ...
            {/* Carte 6: Service d'Urgence 24h/24 */}
            <div className="group overflow-hidden rounded-lg bg-white shadow-lg transition-all hover:shadow-xl">
              <div className="relative h-56 overflow-hidden">
                <Image
        ...
        <div className="container mx-auto px-4">
          <div className="mb-8 text-center">
            <h2 className="text-2xl font-bold text-gray-800 sm:text-3xl">
              Ils ont fait confiance à nos services de débouchage
            </h2>
