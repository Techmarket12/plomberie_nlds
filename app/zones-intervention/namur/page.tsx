...
export const metadata: Metadata = {
  title: "Plomberie et Débouchage Namur | Service 24h/24 et 7j/7",
  description:
    "Services professionnels de plomberie et débouchage à Namur et ses communes environnantes. Intervention rapide en 45 minutes, disponible 24h/24 et 7j/7. Devis gratuit.",
  keywords:
    "plombier Namur, plomberie Namur, débouchage Namur, débouchage canalisation Namur, débouchage WC Namur, débouchage évier Namur, réparation fuite Namur, installation sanitaire Namur, rénovation salle de bain Namur, dépannage plomberie Namur, plombier Andenne, plombier Gembloux, débouchage Profondeville, plombier Ciney, débouchage Rochefort, urgence plomberie Namur",
}

export default function NamurPage() {
  // Liste des communes de Namur et alentours
  const communes = [
    "Anhée",
    "Beauraing",
    "Bièvre",
  ...
  return (
    <div className="bg-white">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h1 className="text-3xl md:text-4xl font-bold mb-4">Plomberie et Débouchage à Namur et ses alentours</h1>
              <p className="text-xl mb-6">Service professionnel disponible 24h/24 et 7j/7</p>
              <p className="mb-8">
                Intervention rapide en moins de 45 minutes sur Namur et toutes les communes environnantes. Nos
            ...
            <div className="md:w-1/2">
              <Image
                ...
                alt="Plomberie et débouchage à Namur"
                width={600}
                height={400}
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Nos services de plomberie à Namur</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              ...
              <p>
                ...
                vos dépannages de plomberie à Namur et ses environs.
              </p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Nos services de débouchage à Namur</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Nos zones d'intervention à Namur et alentours</h2>
          <p className="text-center mb-8 max-w-3xl mx-auto">
            Nous intervenons dans toute la province de Namur pour vos problèmes de plomberie et débouchage. Notre équipe
            se déplace rapidement dans Namur et toutes les communes environnantes.
          </p>
          <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Pourquoi choisir nos services de plomberie et débouchage à Namur ?
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              ...
              <p>Nous intervenons en moins de 45 minutes sur Namur et ses environs, 24h/24 et 7j/7.</p>
            </div>
            <div className="text-center p-6 bg-white rounded-lg shadow-md">
              <div className="bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg
      ...
      <section className="py-16 bg-blue-900 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-6">Besoin d'un plombier ou d'un débouchage en urgence à Namur ?</h2>
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Notre équipe de plombiers professionnels est disponible 24h/24 et 7j/7 pour tous vos problèmes de plomberie
            et canalisations bouchées à Namur et dans toute la province.
          </p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Questions fréquentes sur nos services de plomberie et débouchage à Namur
          </h2>
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2">
                Quel est le délai d'intervention pour un plombier ou un débouchage à Namur ?
              </h3>
              <p>
                Nous intervenons en moins de 45 minutes sur Namur et toutes les communes environnantes. Notre service
                d'urgence est disponible 24h/24 et 7j/7 pour tous types de problèmes de plomberie et débouchage.
              </p>
            </div>
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
            ...
            <div className="bg-gray-50 p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-2">
                Intervenez-vous aussi pour les entreprises et commerces à Namur ?
              </h3>
              <p>
                Oui, nous proposons des services de plomberie et débouchage pour les particuliers, les entreprises, les
                commerces et les collectivités sur Namur et toute la province. Nous offrons également des contrats
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold mb-6">Plomberie et débouchage à Namur - Services professionnels</h2>
            <div className="prose max-w-none">
              <p>
                Notre entreprise de <strong>plomberie et débouchage à Namur</strong> intervient rapidement pour résoudre
                tous vos problèmes. Que vous soyez confronté à une <strong>fuite d'eau à Namur</strong>, un{" "}
                <strong>WC bouché à Andenne</strong>, une <strong>panne de chauffe-eau à Gembloux</strong> ou des{" "}
                <strong>canalisations bouchées à Profondeville</strong>, notre équipe de professionnels dispose de
                l'expertise et du matériel nécessaires pour intervenir efficacement.
              </p>
              <p>
                Nous proposons un <strong>service de plomberie et débouchage 24h/24 et 7j/7</strong> sur toute la
                province de Namur. Nos <strong>plombiers qualifiés</strong> et notre <strong>camion hydrocureur</strong>{" "}
                peuvent se déplacer rapidement à Namur, Andenne, Gembloux, Ciney et toutes les communes environnantes
                pour réaliser tous types de <strong>travaux de plomberie et débouchage</strong>.
              </p>
              <p>
                ...
                <strong>détection de fuites</strong> à Namur et dans toute la province. Nous intervenons aussi bien pour
                les particuliers que pour les professionnels.
              </p>
              <p>
                Pour un <strong>plombier pas cher à Namur</strong>, un{" "}
