...
export const metadata: Metadata = {
  title: "Réparation Boiler | Débouchage Plomberie Service 24",
  description:
    "Service professionnel de réparation de boiler à Namur. Dépannage chauffe-eau, remplacement de résistance, détartrage. Intervention rapide en moins de 45 minutes.",
}

export default function ReparationBoilerPage() {
  return (
    <div className="flex flex-col">
      <ServiceSchema
        name="Réparation Boiler"
        description="Service professionnel de réparation de boiler. Dépannage chauffe-eau, remplacement de résistance, détartrage. Intervention rapide en moins de 45 minutes."
        url="https://debouchage-plomberie-service24.be/services/plomberie/reparation-boiler"
        imageUrl="/images/reparation-boiler.png"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            <h1 className="text-4xl font-bold tracking-tight sm:text-5xl md:text-6xl">
              <span className="block text-white">Réparation</span>
              <span className="block text-blue-400">Boiler</span>
            </h1>
            <p className="mt-6 text-xl text-gray-300">
              Dépannage et réparation rapide de tous types de boilers et chauffe-eau. Intervention en moins de 45
              minutes.
            </p>
      ...
      <section className="bg-white py-16">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2">
            <div>
              <h2 className="text-3xl font-bold text-gray-800">Nos Services de Réparation Boiler</h2>
              <p className="mt-4 text-lg text-gray-600">
                Nous intervenons rapidement pour réparer tous types de problèmes de boiler et chauffe-eau dans votre
                habitation. Notre équipe de plombiers professionnels dispose des compétences et du matériel nécessaires
                ...
                <div className="rounded-lg bg-gray-50 p-6 shadow-md">
                  ...
                  <ul className="mt-4 space-y-3">
                    <li className="flex items-start gap-2">
                      ...
                      <span>Pas d'eau chaude</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="mt-1 h-5 w-5 text-blue-500" />
                      <span>Eau pas assez chaude</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="mt-1 h-5 w-5 text-blue-500" />
                      <span>Fuite au niveau du boiler</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="mt-1 h-5 w-5 text-blue-500" />
                      <span>Remplacement de résistance</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="mt-1 h-5 w-5 text-blue-500" />
                      <span>Détartrage de boiler</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="mt-1 h-5 w-5 text-blue-500" />
                      <span>Remplacement de thermostat</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="mt-1 h-5 w-5 text-blue-500" />
                      <span>Installation de nouveau boiler</span>
                    </li>
                  </ul>
                </div>
            ...
            <div>
              <div className="rounded-lg bg-white p-6 shadow-xl">
                ...
                <div className="mt-6 space-y-6">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Nous réparons votre boiler avec des pièces de qualité pour une solution durable.
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-8 rounded-lg bg-gray-50 p-4">
                  ...
                  <p className="mt-2 text-gray-600">
                    Pour prolonger la durée de vie de votre boiler, faites-le détartrer tous les 2 à 3 ans. Le calcaire
                    réduit l'efficacité énergétique et peut endommager les composants.
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8 rounded-lg bg-blue-500 p-6 text-white shadow-md">
                ...
                <p className="mt-2">Notre équipe est disponible 24h/24 et 7j/7 pour réparer votre boiler en urgence.</p>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            <div className="rounded-lg bg-white p-6 shadow-md">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800">Philippe Leroy</h3>
              ...
              <p className="mt-4 text-gray-600">
                "Plus d'eau chaude un matin, ils sont intervenus dans l'heure. Remplacement de la résistance du boiler
                effectué rapidement et proprement. Service impeccable !"
              </p>
            </div>
            ...
            <div className="rounded-lg bg-white p-6 shadow-md">
              <div className="flex items-center gap-4">
                <div className="h-12 w-12 rounded-full bg-blue-100"></div>
                <div>
                  <h3 className="font-semibold text-gray-800">Nathalie Dubois</h3>
              ...
              <p className="mt-4 text-gray-600">
                "J'ai fait appel à eux pour l'installation d'un nouveau boiler. Conseils pertinents sur le modèle à
                choisir et installation parfaite. Je recommande vivement leurs services."
              </p>
            </div>
            ...
            <div className="rounded-lg bg-white p-6 shadow-md">
              <div className="flex items-center gap-4">
                <div className="h-12 w-12 rounded-full bg-blue-100"></div>
                <div>
                  <h3 className="font-semibold text-gray-800">Marc Janssens</h3>
              ...
              <p className="mt-4 text-gray-600">
                "Détartrage de mon boiler qui ne chauffait plus correctement. Intervention propre et efficace. L'eau est
                de nouveau bien chaude et le boiler consomme moins d'électricité. Merci !"
              </p>
            </div>
          </div>
        </div>
